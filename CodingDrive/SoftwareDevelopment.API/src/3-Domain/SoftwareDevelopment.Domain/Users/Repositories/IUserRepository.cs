...
namespace SoftwareDevelopment.Domain.Users.Repositories;
...
public interface IUserRepository : IRepository<User, UserId>
{
    ...
    Task<VerificationToken?> GetVerificationTokenAsync(string token, CancellationToken cancellationToken = default);
    ...
    Task UpdateVerificationTokenAsync(VerificationToken verificationToken, CancellationToken cancellationToken = default);
}
